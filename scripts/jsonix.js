...
Jsonix.Schema.XSD.Decimal.INSTANCE.LIST = new Jsonix.Schema.XSD.List(Jsonix.Schema.XSD.Decimal.INSTANCE);
    Jsonix.Schema.XSD.Decimal2 = Jsonix.Class(Jsonix.Schema.XSD.AnySimpleType, {
        name : 'Decimal2',
        fix : 2,
        typeName : Jsonix.Schema.XSD.qname('decimal'),
        print : function(value, context, output, scope) {
        ...
        CLASS_NAME : 'Jsonix.Schema.XSD.Decimal2'
    });
    Jsonix.Schema.XSD.Decimal2.INSTANCE = new Jsonix.Schema.XSD.Decimal2();
    Jsonix.Schema.XSD.Decimal2.INSTANCE.LIST = new Jsonix.Schema.XSD.List(Jsonix.Schema.XSD.Decimal2.INSTANCE);
...
Jsonix.Context = Jsonix
		.Class(Jsonix.Mapping.Styled, {
			...
			builtinTypeInfos : [
					...
					Jsonix.Schema.XSD.Decimal2.INSTANCE,
