...
unmarshaller.prototype.unmarshall = function unmarshall(filename, callback, forceSimplify) {
    ...
    /*this.unmarshaller.unmarshalFile(filename, function (myElement) {
        ...
        cleanup(myElement);
        simplify(myElement, forceSimplify);
...
function cleanup(o) {
    ...
    function simplify(o, forceSimplify) {
